  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div 
          className="absolute inset-0 stage-grid opacity-20 parallax-bg"
        ...
        >
          ...
          <div className="absolute bottom-40 right-20 w-48 h-48 border border-primary/10 rotate-45" />
          <div className="absolute top-1/3 right-1/4 w-24 h-24 border border-primary/10" />
        </div>
        ...
        <div className="container relative z-10 text-center py-20 parallax-fg">
          <div className="max-w-4xl mx-auto space-y-8 stage-entrance">
            <div className="inline-block px-6 py-2 rounded-full border border-primary/40 bg-primary/10 backdrop-blur-sm mb-6">
              <span className="text-sm font-medium text-primary tracking-wider uppercase">Reclaiming Digital Dignity</span>
            </div>
      ...
      <section id="problem" className="relative py-32 scroll-mt-20 overflow-hidden">
        {/* Parallax background elements */}
        <div 
          className="absolute inset-0 parallax-bg opacity-10"
          style={{ transform: `translateY(${(scrollY - 800) * 0.15}px)` }}
        >
          <div className="absolute top-20 right-20 w-64 h-64 border border-primary/20 rotate-12" />
          <div className="absolute bottom-20 left-20 w-48 h-48 border border-primary/20 rounded-full" />
        </div>
          ...
          <div className="container relative z-10">
            <div className="max-w-5xl mx-auto space-y-16">
              ...
              <Card className="border-2 border-primary/30 bg-card/50 backdrop-blur-sm">
                <CardContent className="p-10 space-y-6">
                  <div className="flex items-start gap-6">
                    <div className="w-20 h-20 flex items-center justify-center flex-shrink-0 text-primary">
                      <AgenticIcon className="w-full h-full" />
                    </div>
                    <div className="space-y-4 flex-1">
                      ...
                      <div className="grid md:grid-cols-3 gap-4 pt-4">
                        <div className="p-4 rounded-lg bg-primary/5 border border-primary/20">
                          <p className="font-semibold text-sm mb-1">Goal-Oriented</p>
                          <p className="text-xs text-muted-foreground">Pursues objectives independently</p>
                        </div>
                        <div className="p-4 rounded-lg bg-primary/5 border border-primary/20">
                          <p className="font-semibold text-sm mb-1">Tool-Using</p>
                          <p className="text-xs text-muted-foreground">Interacts with external systems</p>
                        </div>
                        <div className="p-4 rounded-lg bg-primary/5 border border-primary/20">
                          <p className="font-semibold text-sm mb-1">Adaptive</p>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <Card className="border-2 border-destructive/30 hover:border-destructive/50 transition-all bg-card/50 backdrop-blur-sm">
                  <CardContent className="p-8 space-y-4">
                    <div className="w-16 h-16 flex items-center justify-center text-destructive">
                      <DignityIcon className="w-full h-full" />
                    </div>
                ...
                <Card className="border-2 border-primary/30 hover:border-primary/50 transition-all bg-card/50 backdrop-blur-sm">
                  <CardContent className="p-8 space-y-4">
                    <div className="w-16 h-16 flex items-center justify-center text-primary">
                      <AugmentationIcon className="w-full h-full" />
                    </div>
              ...
              {/* The Critical Choice */}
              <Card className="border-2 border-primary/30 bg-gradient-to-br from-primary/10 to-transparent backdrop-blur-sm">
      ...
      <section id="blueprint" className="relative py-32 scroll-mt-20 overflow-hidden">
        {/* Parallax background */}
        <div 
          className="absolute inset-0 parallax-bg opacity-10"
          style={{ transform: `translateY(${(scrollY - 1600) * 0.15}px)` }}
        >
          <div className="absolute top-40 left-10 w-56 h-56 border border-primary/20" />
          <div className="absolute bottom-40 right-10 w-72 h-72 border border-primary/20 rotate-45 rounded-full" />
        </div>
                ...
                <CardContent className="p-10 space-y-8">
                  <div className="flex items-center gap-6">
                    <div className="w-20 h-20 flex items-center justify-center text-primary">
                      <MestiereIcon className="w-full h-full" />
                    </div>
                  ...
                  <div className="border-l-4 border-primary pl-8 py-4 space-y-4 bg-primary/5">
              ...
              <Card className="border-2 border-primary bg-card/50 backdrop-blur-sm">
                <CardContent className="p-10 space-y-6">
                  ...
                  <div className="grid md:grid-cols-3 gap-6 pt-6">
                    <div className="text-center space-y-3">
                      <div className="w-16 h-16 mx-auto text-primary">
                        <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <circle cx="50" cy="35" r="15" stroke="currentColor" strokeWidth="2" fill="currentColor" opacity="0.2" />
                          <path d="M35 50 Q50 60, 65 50" stroke="currentColor" strokeWidth="2" fill="none" />
                          <path d="M35 65 L35 85 M50 70 L50 85 M65 65 L65 85" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
                        </svg>
                      </div>
                    ...
                    <div className="text-center space-y-3">
                      <div className="w-16 h-16 mx-auto text-primary">
                        <IntellectIcon className="w-full h-full" />
                      </div>
                    ...
                    <div className="text-center space-y-3">
                      <div className="w-16 h-16 mx-auto text-primary">
                        <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M50 25 L50 45" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" />
                          <circle cx="50" cy="55" r="10" stroke="currentColor" strokeWidth="2" fill="currentColor" opacity="0.3" />
                          <path d="M35 70 L50 75 L65 70" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />
                        </svg>
                      </div>
      ...
      <section id="framework" className="relative py-32 scroll-mt-20 overflow-hidden">
        {/* Parallax background */}
        <div 
          className="absolute inset-0 parallax-bg opacity-10"
          style={{ transform: `translateY(${(scrollY - 2800) * 0.15}px)` }}
        >
          <div className="absolute top-20 right-1/4 w-64 h-64 border border-primary/20 rotate-12" />
          <div className="absolute bottom-20 left-1/4 w-48 h-48 border border-primary/20" />
        </div>
        ...
        <CurtainTransition>
          <div className="container relative z-10">
            <div className="max-w-6xl mx-auto space-y-16">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                {/* Pillar 1 */}
                <Card className="border-2 hover:border-blue-500/50 transition-all group bg-card/50 backdrop-blur-sm">
                  <CardContent className="p-8 space-y-6">
                    <div className="flex items-center gap-4">
                      <div className="w-16 h-16 text-blue-500 group-hover:scale-110 transition-transform">
                        <IntellectIcon className="w-full h-full" />
                      </div>
                      <div>
                ...
                {/* Pillar 2 */}
                <Card className="border-2 hover:border-pink-500/50 transition-all group bg-card/50 backdrop-blur-sm">
                  <CardContent className="p-8 space-y-6">
                    <div className="flex items-center gap-4">
                      <div className="w-16 h-16 text-pink-500 group-hover:scale-110 transition-transform">
                ...
                {/* Pillar 3 */}
                <Card className="border-2 hover:border-amber-500/50 transition-all group bg-card/50 backdrop-blur-sm">
                  <CardContent className="p-8 space-y-6">
                    <div className="flex items-center gap-4">
                      <div className="w-16 h-16 text-amber-500 group-hover:scale-110 transition-transform">
                        <EthicalIcon className="w-full h-full" />
                      </div>
                      <div>
                ...
                {/* Pillar 4 */}
                <Card className="border-2 hover:border-purple-500/50 transition-all group bg-card/50 backdrop-blur-sm">
                  <CardContent className="p-8 space-y-6">
                    <div className="flex items-center gap-4">
                      <div className="w-16 h-16 text-purple-500 group-hover:scale-110 transition-transform">
                        <OperationalIcon className="w-full h-full" />
                      </div>
                      <div>
              ...
              <Card className="border-2 border-primary bg-gradient-to-br from-primary/10 to-transparent backdrop-blur-sm">
      ...
      <section id="loyalty" className="relative py-32 scroll-mt-20 overflow-hidden">
        {/* Parallax background */}
        <div 
          className="absolute inset-0 parallax-bg opacity-10"
          style={{ transform: `translateY(${(scrollY - 4200) * 0.15}px)` }}
        >
          <div className="absolute top-40 left-20 w-56 h-56 border border-primary/20 rounded-full" />
          <div className="absolute bottom-20 right-20 w-64 h-64 border border-primary/20 rotate-45" />
        </div>
          ...
          <div className="container relative z-10">
            <div className="max-w-5xl mx-auto space-y-16">
              ...
              <Card className="border-2 border-primary/30 bg-gradient-to-br from-primary/10 to-transparent backdrop-blur-sm">
                <CardContent className="p-10 space-y-8">
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-center gap-8 py-8">
                    <div className="text-center space-y-3">
                      <div className="w-24 h-24 rounded-full bg-primary/20 flex items-center justify-center mx-auto border-4 border-primary backdrop-blur-sm">
                    ...
                    <div className="text-center space-y-3">
                      <div className="w-24 h-24 rounded-full bg-primary/20 flex items-center justify-center mx-auto border-4 border-primary backdrop-blur-sm">
                        <LoyaltyIcon className="w-12 h-12 text-primary" />
                      </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-3 gap-6 pt-6">
                  <Card className="border-2 hover:border-primary/50 transition-all bg-card/50 backdrop-blur-sm">
                    <CardContent className="p-6 space-y-4">
                      <div className="w-12 h-12 text-primary">
                        <GovernanceIcon className="w-full h-full" />
                      </div>
                  ...
                  <Card className="border-2 hover:border-primary/50 transition-all bg-card/50 backdrop-blur-sm">
                    <CardContent className="p-6 space-y-4">
                      <div className="w-12 h-12 text-primary">
                        <ToolingIcon className="w-full h-full" />
                      </div>
                    ...
                    <CardContent className="p-6 space-y-4">
                      <div className="w-12 h-12 text-primary">
                        <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <path d="M50 20 L50 50 L70 50" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" />
                  ...
                  <Card className="border-2 hover:border-primary/50 transition-all bg-card/50 backdrop-blur-sm">
                    <CardContent className="p-6 space-y-4">
                      <div className="w-12 h-12 text-primary">
                        <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <circle cx="50" cy="50" r="25" stroke="currentColor" strokeWidth="2" fill="currentColor" opacity="0.1" />
                          <path d="M40 50 L48 58 L62 42" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                      </div>
      ...
      <section id="intuition" className="relative py-32 scroll-mt-20 overflow-hidden">
        {/* Parallax background */}
        <div 
          className="absolute inset-0 parallax-bg opacity-10"
          style={{ transform: `translateY(${(scrollY - 5800) * 0.15}px)` }}
        >
          <div className="absolute top-20 left-1/4 w-72 h-72 border border-primary/20" />
          <div className="absolute bottom-40 right-1/4 w-56 h-56 border border-primary/20 rotate-45 rounded-full" />
        </div>
                ...
                <CardContent className="p-10 space-y-8">
                  <div className="flex items-center justify-center gap-12 py-8">
                    ...
                    <div className="flex-1 max-w-md space-y-4">
                      ...
                      <div className="text-center space-y-2 py-4 px-6 bg-primary/10 rounded-lg border-2 border-primary/30">
                        <div className="w-16 h-16 mx-auto text-primary">
                          <IntuitionIcon className="w-full h-full" />
                        </div>
                    ...
                    <div className="text-center space-y-3">
                      <div className="w-20 h-20 mx-auto text-amber-500">
                        <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <circle cx="50" cy="35" r="15" stroke="currentColor" strokeWidth="2" fill="currentColor" opacity="0.2" />
                          <path d="M35 50 Q50 60, 65 50" stroke="currentColor" strokeWidth="2" fill="none" />
                          <path d="M35 65 L35 85 M50 70 L50 85 M65 65 L65 85" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
                          <path d="M45 30 L50 20 L55 30" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                      </div>
            ...
            <div className="max-w-4xl mx-auto text-center space-y-12">
              ...
              <div className="pt-8 space-y-8">
                ...
                <div className="grid md:grid-cols-3 gap-6 pt-8">
                  <div className="p-6 bg-card/50 backdrop-blur-sm rounded-lg border-2 border-primary/20">
                  ...
                  <div className="p-6 bg-card/50 backdrop-blur-sm rounded-lg border-2 border-primary/20">
                    <div className="w-12 h-12 mx-auto mb-4 text-primary">
                      <LoyaltyIcon className="w-full h-full" />
                    </div>
      ...
      {/* Footer */}
      <footer className="py-16 border-t border-border/50 bg-card/30 backdrop-blur-sm">
