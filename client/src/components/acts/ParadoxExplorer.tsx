    ...
    <div id="section-paradox" ref={containerRef} className="relative bg-black">
      ...
      {paradoxes.map((p, i) => (
        ...
        >
          ...
          <div className="absolute inset-0 opacity-20 mix-blend-overlay pointer-events-none" style={{ backgroundImage: `url('https://d2xsxph8kpxj0f.cloudfront.net/310519663267931784/KHL22GhjgeeQPRRyxwJ5K4/texture-noise_a856544f.jpg')` }} />
