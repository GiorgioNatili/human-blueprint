...
const slides: Slide[] = [
  ...
  },
  {
    ...
    body: "Unlike traditional AI that suggests or recommends, agentic AI acts. It makes decisions, executes tasks, negotiates with other systems, and adapts its strategies based on outcomes — without continuous human intervention. This shift from advisory to executive function introduces profound questions about control, trust, and dignity.",
  ...
  },
  {
    ...
    body: "A single agent acts on behalf of one user — a personal assistant that books your travel, manages your calendar, and handles your correspondence. A multi-agent system deploys networks of specialized agents that coordinate to accomplish complex goals. Both architectures raise the same fundamental question: whose interests does the agent serve?",
  ...
  },
  {
    ...
    body: "Every agentic system operates through a continuous loop. It perceives its environment (data, APIs, user context), plans a sequence of actions to achieve its goal, acts by executing those steps, learns from the outcomes, and repeats. The loop runs autonomously — which is precisely what makes alignment non-negotiable at every node.",
  ...
  },
  {
    ...
    body: "This reframing shifts from passive fear to active agency. From zero-sum competition to positive-sum partnership. From technological determinism to intentional architecture. The rest of this presentation provides the framework for answering that question — The Human Blueprint.",
